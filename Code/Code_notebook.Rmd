...
This is file contains the code to reproduce the results in the main paper.
...
These analyses are performed on subset of 642 with data on DENV titers prior to Zika outbreak (variable coh642=1)
